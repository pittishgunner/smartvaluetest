...
--
-- Host: localhost
-- Generation Time: Oct 04, 2018 at 04:00 PM
...
--
-- Database: `smartvalue_orig`
--
CREATE DATABASE IF NOT EXISTS `smartvalue_orig` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `smartvalue_orig`;
